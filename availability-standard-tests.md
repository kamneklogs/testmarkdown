...
To create an availability test, you must use an existing Application Insights resource or [create an Application Insights resource](https://learn.microsoft.com/en-us/azure/azure-monitor/app/media/availability-standard-test/standard-test.png).
...
1. Select **Add Standard test**.
    ...
    ![Screenshot that shows the Availability pane with the Add Standard test tab open.](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/media/availability-standard-test/standard-test.png)
...
![Screenshot that shows the Availability page with the Refresh button highlighted.](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/media/monitor-web-app-availability/availability-refresh-002.png)
...
![Screenshot that shows the Line view.](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/media/monitor-web-app-availability/availability-scatter-plot-003.png)
...
![Screenshot that shows the View test details. Edit and Disable a web test.](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/media/monitor-web-app-availability/edit.png)
...
![Screenshot that shows the End-to-end transaction details tab.](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/media/monitor-web-app-availability/end-to-end.png)
...
To learn more about the end-to-end transaction diagnostics experience, see the [transaction diagnostics documentation](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/transaction-diagnostics).

Select the exception row to see the details of the server-side exception that caused the synthetic availability test to fail. You can also get the [debug snapshot](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/snapshot-debugger) for richer code-level diagnostics.

![Screenshot that shows the Server-side diagnostics.](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/media/monitor-web-app-availability/open-instance-4.png)

In addition to the raw results, you can also view two key availability metrics in [metrics explorer](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/essentials/metrics-getting-started):
...
* [Availability alerts](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/availability-alerts)
* [Multi-step web tests](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/availability-multistep)
* [Troubleshooting](https://learn.microsoft.com/en-us/DocsWithTextRepo/azure-monitor/app/troubleshoot-availability)
* [Web tests Azure Resource Manager template](https://learn.microsoft.com/en-us/azure/templates/microsoft.insights/webtests?tabs=json)
